...
class UserManagementTestCase(TestCase):
    def setUp(self):
        ...
        # Create Users
        self.super_admin = User.objects.create(username='superadmin', email='superadmin@example.com', organization=self.org1)
        self.super_admin.roles.add(self.super_admin_role)
        
        self.admin = User.objects.create(username='admin', email='admin@example.com', organization=self.org1)
